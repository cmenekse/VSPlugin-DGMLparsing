...
namespace Company.VSPackageTitleName
{
    ...
    //     - An empty vspackagetitlename file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.vspackagetitlename. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.vspackagetitlename, MyExtFile2.vspackagetitlename... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.vspackagetitlename|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.vspackagetitlename - our empty vspackagetitlename file
    ...
    //    - #107 - the ID of "vspackagetitlename"
    ///////////////////////////////////////////////////////////////////////////////
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".vspackagetitlename";
        ...
        #region Fields
        private VSPackageTitleNamePackage myPackage;
        ...
        public EditorPane(VSPackageTitleNamePackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the vspackagetitlename document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(VSPackageTitleNamePackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidVSPackageTitleNameCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidVSPackageTitleNameCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidVSPackageTitleNameEditorFactory;
            return VSConstants.S_OK;
        }
