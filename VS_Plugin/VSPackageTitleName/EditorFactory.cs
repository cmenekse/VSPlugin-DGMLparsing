...
namespace Company.VSPackageTitleName
{
    ...
    /// </summary>
    [Guid(GuidList.guidVSPackageTitleNameEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private VSPackageTitleNamePackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(VSPackageTitleNamePackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidVSPackageTitleNameEditorFactory;
            pgrfCDW = 0;
