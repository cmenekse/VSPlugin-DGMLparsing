...
namespace VSPackageTitleName_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Company.VSPackageTitleName.GuidList.guidVSPackageTitleNameCmdSet, (int)Company.VSPackageTitleName.PkgCmdIDList.cmdidMyCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VSPackageTitleName", "Company.VSPackageTitleName.VSPackageTitleNamePackage");
