...
using Company.VSPackageTitleName;

namespace VSPackageTitleName_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSPackageTitleNamePackage() as IVsPackage;
            ...
            BaseMock registerEditor = VSPackageTitleName_UnitTests.EditorTests.RegisterEditorsServiceMock.GetRegisterEditorsInstance();
            ...
            CommandID menuCommandID = new CommandID(Company.VSPackageTitleName.GuidList.guidVSPackageTitleNameCmdSet, (int)Company.VSPackageTitleName.PkgCmdIDList.cmdidMyCommand);
